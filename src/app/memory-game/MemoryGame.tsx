...
import shuffleCards, { type MemoryCard } from "@/utils/shuffledCards";
...
const MemoryGame = () => {
  ...
  return (
    <>
      ...
      >
        <DialogPanel className="absolute p-9 inset-1/2 -translate-x-1/2 -translate-y-1/2 bg-green-400 w-64 h-fit rounded-xl shadow-xl">
