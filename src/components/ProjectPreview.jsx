...
const ProjectPreview = ({ project, last }) => {
  ...
  // Website projects have a slug and route through their own detail page;
  // interactive demos link straight to their demo route.
  const Wrapper = slug ? Link : "a";
  const wrapperProps = slug
    ? { to: `/projects/${slug}` }
    : { href: link, target: link.startsWith("http") ? "_blank" : "_self" };
