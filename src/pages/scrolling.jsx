      ...
      <div className="" ref={container}>
        ...
        <section className="h-screen orange bg-gradient-to-b to-white from-orange-400 flex flex-col items-center justify-center relative">
          ...
          <p>
            ...
            viewport, then the line's animation is linked with the scroll
            position until it has traveled 100% of the viewport's height (
            ...
            rest of the content down so that it catches up with the scroll when
        ...
        <section className="h-screen purple bg-gradient-to-b from-purple-400 to-white flex flex-col items-center justify-center">
          ...
          <p>
            ...
            and animating the transforms of the paragraph in addition to the
            line, all synced with the scroll position perfectly.
          </p>
        </section>
